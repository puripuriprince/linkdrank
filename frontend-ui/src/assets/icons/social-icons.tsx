...
// Base Tailwind classes to mimic { width: 20, height: 'auto', flexShrink: 0 }
const baseClass = "w-5 h-auto flex-shrink-0";

// ----------------------------------------------------------------------
// LinkedinIcon
export const LinkedinIcon = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(
    ({ className, ...other }, ref) => {
        return (
            <svg
                ref={ref}
                className={`${baseClass} text-[#0A66C2] ${className || ""}`}
                viewBox="0 0 24 24"
                fill="currentColor"
                {...other}
            >
...
// ----------------------------------------------------------------------
// FacebookIcon
export const FacebookIcon = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(
    ({ className, ...other }, ref) => {
        return (
            <svg
                ref={ref}
                className={`${baseClass} text-[#1877F2] ${className || ""}`}
                viewBox="0 0 24 24"
                fill="currentColor"
                {...other}
            >
...
// ----------------------------------------------------------------------
// DiscordIcon
// Here we leverage the Iconify component (styled via Tailwind) for consistency.
export const DiscordIcon = (props: React.SVGProps<SVGSVGElement>) => {
    const { className, ...other } = props;
    return (
        <Iconify
            icon="logos:discord-icon"
            className={`${baseClass} text-[#5865F2] ${className || ""}`}
            width={16}
        />
    );
};
...
export const GithubIcon = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(
    ({ className, ...other }, ref) => {
        return (
            <svg
                ref={ref}
                className={`${baseClass} text-current ${className || ""}`}
                viewBox="0 0 24 24"
                fill="currentColor"
                {...other}
            >
...
// ----------------------------------------------------------------------
// TwitterIcon
export const TwitterIcon = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(
    ({ className, ...other }, ref) => {
        return (
            <svg
                ref={ref}
...
// ----------------------------------------------------------------------
// GoogleIcon
export const GoogleIcon = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(
    ({ className, ...other }, ref) => {
        return (
            <svg
                ref={ref}
...
// ----------------------------------------------------------------------
// InstagramIcon (with gradients)
export const InstagramIcon = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(
    ({ className, ...other }, ref) => {
