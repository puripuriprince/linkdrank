        ...
        <section
          ...
          for
            ...
            <div className="min-h-28 w-full max-w-2xl border bg-gray-100/85 backdrop-blur-xl backdrop-saturate-200 dark:bg-gray-900/80 rounded-2xl">
                ...
                <div
                    className="relative w-full flex flex-row flex-nowrap items-center justify-between gap-1 overflow-x-auto">
                    <span aria-hidden="true" className="inline-block h-10"></span>
                    <Button
                        type="submit"
                        variant="default"
                        size="icon"
