						...
						>
							<div className="relative mr-2">
								...
								<Button
									...
									variant="ghost"
									size="icon"
									className="!bg-background -left-2 !size-5 !p-1 hover:!bg-destructive/10 dark:hover:!bg-destructive/20 absolute top-0.5 cursor-pointer rounded-full text-muted-foreground opacity-0 hover:text-destructive group-hover/bullet:opacity-100"
								>
									<X className="size-4" />
								</Button>
							</div>
